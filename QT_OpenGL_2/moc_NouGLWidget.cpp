...
QT_MOC_LITERAL(1, 12, 9), // "sigcamera"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 8) // "QTCamera"

    },
    "NouGLWidget\0sigcamera\0\0QTCamera"
};
...
void NouGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sigcamera(); break;
        case 1: _t->QTCamera(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (NouGLWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NouGLWidget::sigcamera)) {
                *result = 0;
                return;
            }
        }
